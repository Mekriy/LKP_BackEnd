    ...
    public class DbInitializer
    {
        ...
        public void SeedUsers()
        {
            if (!context.Users.Any())
            {
                ...
                {
                    new User() {UserName="Oles", Email="oles@gamil.com", PasswordHash="P@ssword123", Role = "Admin"},
                    new User() {UserName="Andriy", Email="andriy@gamil.com", PasswordHash="P@ssword123", Role = "Admin"},
                    new User() {UserName="Dima", Email="dima@gamil.com", PasswordHash="P@ssword123", Role = "Admin"}
                };
